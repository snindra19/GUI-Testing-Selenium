...
public class GuiTestCasesV1Test {
    ...
    private void goToPage1Html() {
        String path = System.getProperty("user.dir") + "/../GUI Version 1/pages/page1.html";
        path = "file:///" + path.replace("\\", "/");
        driver.get(path);
    }
    private void goToPage2Html() {
        String path = System.getProperty("user.dir") + "/../GUI Version 1/pages/page2.html";
        path = "file:///" + path.replace("\\", "/");
        driver.get(path);
    }
    private void goToPage3Html() {
        String path = System.getProperty("user.dir") + "/../GUI Version 1/pages/page3.html";
        path = "file:///" + path.replace("\\", "/");
        driver.get(path);
    }
    private void goToPage4Html() {
        String path = System.getProperty("user.dir") + "/../GUI Version 1/pages/page4.html";
        path = "file:///" + path.replace("\\", "/");
        driver.get(path);
    }
    private void goToPage6Html() {
        String path = System.getProperty("user.dir") + "/../GUI Version 1/pages/page6.html";
        path = "file:///" + path.replace("\\", "/");
        driver.get(path);
    }
